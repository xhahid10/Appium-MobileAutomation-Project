...
# PFG Comprehensive Sanity Test Suite Runner
# This script runs the complete sanity test suite including multi-device sequential tests

echo "=========================================="
echo "PFG Comprehensive Sanity Test Suite"
echo "=========================================="
echo ""

# Set environment variables
export BUILD_NAME="PFG_Comprehensive_Sanity_$(date +%Y%m%d_%H%M%S)"
...
run_sanity_tests() {
    echo "Starting Comprehensive Sanity Test Suite..."
    echo "This will run:"
    echo "1. Single Device Sanity Tests (7 tests)"
    echo "2. Multi-Device Sequential Tests (5 devices)"
    echo ""
    
    # Run the comprehensive sanity suite
    mvn test -DsuiteXmlFile=src/test/resources/comprehensive-sanity-suite.xml \
    ...
    if [ $? -eq 0 ]; then
        echo ""
        echo "✅ Comprehensive Sanity Test Suite completed successfully!"
        echo "📊 Reports generated in: test-output/reports/"
        echo "📸 Screenshots saved in: test-output/screenshots/"
    else
        echo ""
        echo "❌ Comprehensive Sanity Test Suite failed!"
...
show_execution_plan() {
    ...
    echo "========================"
    echo ""
    echo "PART 1: Single Device Sanity Tests (Galaxy S23)"
    ...
    echo ""
    echo "PART 2: Multi-Device Sequential Tests"
    echo "├── Galaxy S23 Ultra (Android 13.0)"
    echo "├── OnePlus 11 (Android 13.0)"
    echo "├── Pixel 8 (Android 14.0)"
    echo "├── Galaxy S24 Ultra (Android 14.0)"
    echo "└── OnePlus 10 Pro (Android 12.0)"
    echo ""
    echo "⏱️  Estimated Total Time: 45-60 minutes"
    echo "💰 Estimated Cost: ~60-80 device-minutes"
    echo ""
}
...
show_help() {
    ...
    echo "  -r, --run           Run the comprehensive sanity suite"
